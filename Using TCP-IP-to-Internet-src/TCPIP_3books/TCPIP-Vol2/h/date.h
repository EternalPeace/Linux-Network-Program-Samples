...
#define	net2xt(x)	((x)-2208988800U)  /* convert net-to-xinu time	*/
#define	xt2net(x)	((x)+2208988800U)  /* convert xinu-to-net time	*/
...
SYSCALL gettime(unsigned long *), getutim(unsigned long *);
int ascdate(long, char *);
