...
instr_t instruction_set[] = 
{
    ...
    /* arg1hi indicates number of bytes */
    {"jmp",    HPACK(I_JMP, J_YES), 5, I_ARG, 1, 4, NO_ARG, 0, 0 },
    {"jle",    HPACK(I_JMP, J_LE), 5, I_ARG, 1, 4, NO_ARG, 0, 0 },
    {"jl",     HPACK(I_JMP, J_L), 5, I_ARG, 1, 4, NO_ARG, 0, 0 },
    {"je",     HPACK(I_JMP, J_E), 5, I_ARG, 1, 4, NO_ARG, 0, 0 },
    {"jne",    HPACK(I_JMP, J_NE), 5, I_ARG, 1, 4, NO_ARG, 0, 0 },
    {"jge",    HPACK(I_JMP, J_GE), 5, I_ARG, 1, 4, NO_ARG, 0, 0 },
    {"jg",     HPACK(I_JMP, J_G), 5, I_ARG, 1, 4, NO_ARG, 0, 0 },
    ...
    {"iaddl",  HPACK(I_IADDL, 0), 6, I_ARG, 2, 4, R_ARG, 1, 0 },
